...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'productdb'),
        'USER': os.environ.get('POSTGRES_USER', 'postgres'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', '275498'),
...
def get_required_env(name):
    ...
    if not value:
        raise ImproperlyConfigured(
            f"{name} is required. Add it to backend/.env or your deployment environment."
        )
    return value
